...
const Form = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        }, 1000); // Delay the success notification for 1 second (simulated).

        // For a real form submission, replace the above setTimeout with your axios post request.
    };
            ...
            <div className="App">
                <div className="container mt-5">
                    <div className="form-container border rounded p-4">
                        <h1 className="mb-4 text-center">Customized SOP Generator</h1>
                        <p>
